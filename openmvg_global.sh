...
OPENMVG_BIN="/Users/manavvora/Desktop/AE598-Final-Project/openMVG_Build/Darwin-arm64-RELEASE"
...
${OPENMVG_BIN}/openMVG_main_SfM --sfm_engine GLOBAL --input_file ${MATCHES_DIR}/sfm_data.json --match_file ${MATCHES_DIR}/matches.putative.bin --output_dir ${RECONSTRUCTION_DIR}

echo "Step 6: Colorize structure"
${OPENMVG_BIN}/openMVG_main_ComputeSfM_DataColor -i ${RECONSTRUCTION_DIR}/sfm_data.bin -o ${RECONSTRUCTION_DIR}/colorized_global.ply
